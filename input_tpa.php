                        ...
                        <form method="post" action="insert_tpa.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-12">
                                <div class="alert alert-info">
                                    <i class="fa fa-info-circle"></i> Nama Yang Ditampilkan adalah nama alternatif yang belum dinilai...
                                </div>
                                <label for="nama">Nama Alternatif</label>
                                <select required class="form-control" name="id_calon_kr">
                                    <?php foreach ($db->select('*', 'alternatif')->where('id_calon_kr not in (select id_calon_kr from hasil_tpa)')->get() as $val) : ?>
