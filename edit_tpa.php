                ...
                <div class="card card-body mt-3 mb-5 panel panel-default">
                    ...
                    <div class="panel-body">
                        <form method="post" action="update_tpa.php">
                            ...
                            <?php endif ?>
                            <?php foreach ($db->select('hasil_tpa.*,alternatif.id_calon_kr,alternatif.nama', 'hasil_tpa,alternatif')->where('hasil_tpa.id_calon_kr=alternatif.id_calon_kr and hasil_tpa.id_calon_kr=' . $_GET['id'])->get() as $data) : ?>
